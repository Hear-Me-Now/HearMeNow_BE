namespace :sheets_load do
  task sound_cards: :environment do
    ...
    sound_card_data = SheetFacade.get_sheets("Sound%20Cards")[:values]
    sound_card_data.shift
  ...
  task wrong_answers: :environment do
    ...
    wrong_answer_data = SheetFacade.get_sheets("Wrong%20Answers")[:values]
    wrong_answer_data.shift
